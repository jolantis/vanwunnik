...
c::set('sitemap.images.license', 'https://creativecommons.org/licenses/by-nc-nd/4.0/'); // License URL for your site's images
...
c::set('sitemap.frequency', true);                                              // Show/hide change frequency attribute
