...
c::set('language.multi', true);                                                 // Enable multi-language support (also make sure to out-comment the `languages` variabel array below!)
...
c::set('language.detect', true);                                                // Enables automatic language detection for multi-language sites
