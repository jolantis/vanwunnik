...
c::set('cache.options', array('prefix' => 'vanwunnik_'));                       // Prefix memcached keys (prevent collision of caches when pages are named the same, acros sites in a multisite environment)
